...
export const networks = {
  standalone: {
    ...
    contractId: "CDY5TQVLB26INEFJ6YPJSQVZW7TTGQIM2Q6ZJGH3VGD5MIGJBDVVYEMZ",
  }
} as const
...
export interface Client {
  ...
  /**
   * Construct and simulate a mint_with_royalty transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  mint_with_royalty: ({to, receiver, basis_points}: {to: string, receiver: string, basis_points: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_royalty_info: ({token_id, sale_price}: {token_id: u32, sale_price: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
     ...
     */
    simulate?: boolean;
  }) => Promise<AssembledTransaction<readonly [string, i128]>>
   ...
   */
  set_default_royalty: ({receiver, basis_points, operator}: {receiver: string, basis_points: u32, operator: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_token_royalty: ({token_id, receiver, basis_points, operator}: {token_id: u32, receiver: string, basis_points: u32, operator: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  remove_token_royalty: ({token_id, operator}: {token_id: u32, operator: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  royalty_info: ({token_id, sale_price}: {token_id: u32, sale_price: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAIAAAAAAAAABWFkbWluAAAAAAAAEwAAAAAAAAAHbWFuYWdlcgAAAAATAAAAAA==",
        "AAAAAAAAAAAAAAAEbWludAAAAAEAAAAAAAAAAnRvAAAAAAATAAAAAQAAAAQ=",
        "AAAAAAAAAAAAAAARbWludF93aXRoX3JveWFsdHkAAAAAAAADAAAAAAAAAAJ0bwAAAAAAEwAAAAAAAAAIcmVjZWl2ZXIAAAATAAAAAAAAAAxiYXNpc19wb2ludHMAAAAEAAAAAQAAAAQ=",
        "AAAAAAAAAAAAAAAQZ2V0X3JveWFsdHlfaW5mbwAAAAIAAAAAAAAACHRva2VuX2lkAAAABAAAAAAAAAAKc2FsZV9wcmljZQAAAAAACwAAAAEAAAPtAAAAAgAAABMAAAAL",
  ...
  public readonly fromJSON = {
    mint: this.txFromJSON<u32>,
        mint_with_royalty: this.txFromJSON<u32>,
        get_royalty_info: this.txFromJSON<readonly [string, i128]>,

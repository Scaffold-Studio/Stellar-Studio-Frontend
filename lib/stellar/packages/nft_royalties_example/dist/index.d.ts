...
export declare const networks: {
    readonly standalone: {
        ...
        readonly contractId: "CDY5TQVLB26INEFJ6YPJSQVZW7TTGQIM2Q6ZJGH3VGD5MIGJBDVVYEMZ";
    };
};
/**
...
export interface Client {
     ...
     */
    mint_with_royalty: ({ to, receiver, basis_points }: {
        to: string;
        receiver: string;
        basis_points: u32;
    }, options?: {
     ...
     */
    get_royalty_info: ({ token_id, sale_price }: {
        token_id: u32;
        sale_price: i128;
    }, options?: {
        /**
     ...
     */
    set_default_royalty: ({ receiver, basis_points, operator }: {
        receiver: string;
        basis_points: u32;
        operator: string;
    }, options?: {
     ...
     */
    set_token_royalty: ({ token_id, receiver, basis_points, operator }: {
        token_id: u32;
        receiver: string;
        basis_points: u32;
        operator: string;
     ...
     */
    remove_token_royalty: ({ token_id, operator }: {
        token_id: u32;
        operator: string;
    }, options?: {
        /**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        mint_with_royalty: (json: string) => AssembledTransaction<number>;
        get_royalty_info: (json: string) => AssembledTransaction<readonly [string, bigint]>;
        ...
        set_default_royalty: (json: string) => AssembledTransaction<null>;
        set_token_royalty: (json: string) => AssembledTransaction<null>;
        remove_token_royalty: (json: string) => AssembledTransaction<null>;
        royalty_info: (json: string) => AssembledTransaction<readonly [string, bigint]>;

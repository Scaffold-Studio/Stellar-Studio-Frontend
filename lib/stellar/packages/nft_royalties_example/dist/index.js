...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAIAAAAAAAAABWFkbWluAAAAAAAAEwAAAAAAAAAHbWFuYWdlcgAAAAATAAAAAA==",
    ...
    fromJSON = {
        ...
        mint_with_royalty: (this.txFromJSON),
        get_royalty_info: (this.txFromJSON),
        ...
        set_default_royalty: (this.txFromJSON),
        set_token_royalty: (this.txFromJSON),
        remove_token_royalty: (this.txFromJSON),

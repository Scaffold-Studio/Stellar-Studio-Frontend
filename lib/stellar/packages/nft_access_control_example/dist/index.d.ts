...
export declare const networks: {
    readonly standalone: {
        ...
        readonly contractId: "CAGSKMHTYHPL2NPCKLTK4ME7AR6QJEWWTKWWDTBUJ4XRZJ6TYGGLVZFS";
    };
};
/**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        admin_restricted_function: (json: string) => AssembledTransaction<string[]>;
        mint: (json: string) => AssembledTransaction<null>;
        multi_role_action: (json: string) => AssembledTransaction<string>;
        multi_role_auth_action: (json: string) => AssembledTransaction<string>;

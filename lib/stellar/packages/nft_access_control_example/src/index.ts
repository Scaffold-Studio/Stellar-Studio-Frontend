...
export const networks = {
  standalone: {
    ...
    contractId: "CAGSKMHTYHPL2NPCKLTK4ME7AR6QJEWWTKWWDTBUJ4XRZJ6TYGGLVZFS",
  }
} as const
...
export interface Client {
  /**
   * Construct and simulate a admin_restricted_function transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  admin_restricted_function: (options?: {
    /**
   ...
   */
  mint: ({caller, to, token_id}: {caller: string, to: string, token_id: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a multi_role_action transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  multi_role_action: ({caller}: {caller: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a multi_role_auth_action transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  multi_role_auth_action: ({caller}: {caller: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAEAAAAAAAAABWFkbWluAAAAAAAAEwAAAAA=",
        "AAAAAAAAAAAAAAAZYWRtaW5fcmVzdHJpY3RlZF9mdW5jdGlvbgAAAAAAAAAAAAABAAAD6gAAABA=",
        "AAAAAAAAAAAAAAAEbWludAAAAAMAAAAAAAAABmNhbGxlcgAAAAAAEwAAAAAAAAACdG8AAAAAABMAAAAAAAAACHRva2VuX2lkAAAABAAAAAA=",
        "AAAAAAAAAAAAAAARbXVsdGlfcm9sZV9hY3Rpb24AAAAAAAABAAAAAAAAAAZjYWxsZXIAAAAAABMAAAABAAAAEA==",
        "AAAAAAAAAAAAAAAWbXVsdGlfcm9sZV9hdXRoX2FjdGlvbgAAAAAAAQAAAAAAAAAGY2FsbGVyAAAAAAATAAAAAQAAABA=",
  ...
  public readonly fromJSON = {
    admin_restricted_function: this.txFromJSON<Array<string>>,
        mint: this.txFromJSON<null>,
        multi_role_action: this.txFromJSON<string>,
        multi_role_auth_action: this.txFromJSON<string>,

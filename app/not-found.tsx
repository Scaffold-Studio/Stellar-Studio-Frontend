        ...
        >
          ...
          >
            <div className="relative inline-block">
              <div className="size-32 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <div className="absolute -bottom-4 -left-4 size-6 bg-primary/60 rounded-full animate-pulse delay-1000"></div>
            </div>
          </motion.div>
          ...
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            ...
            Let's get you back to exploring Stellar Studio.
          </p>

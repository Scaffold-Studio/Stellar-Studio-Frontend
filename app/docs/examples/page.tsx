    ...
    <div className="py-12 px-6 lg:px-12">
                    ...
                    {category.examples.map((example, i) => (
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <Terminal className="size-4 text-cyan-500 shrink-0 mt-1" />
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6">
            <div className="size-12 bg-cyan-500/20 rounded-lg flex items-center justify-center mb-4">
          ...
          <Card className="p-6">
            <div className="size-12 bg-blue-500/20 rounded-lg flex items-center justify-center mb-4">
          ...
          <Card className="p-6">
            <div className="size-12 bg-purple-500/20 rounded-lg flex items-center justify-center mb-4">
      ...
      >
        <Card className="p-8 bg-gradient-to-r from-cyan-500/10 to-cyan-500/5 border-cyan-500/20">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="size-2 bg-cyan-500 rounded-full mt-2 shrink-0"></div>

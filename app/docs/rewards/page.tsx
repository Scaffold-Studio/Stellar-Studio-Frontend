    ...
    <div className="py-12 px-6 lg:px-12">
      ...
      >
        ...
        <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mb-8">
          Stellar Studio will revolutionize blockchain development by rewarding every action you take.
          Earn real value while building, transacting, and contributing to the Stellar ecosystem.
        </p>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="p-6 text-center">
            <div className="size-12 bg-cyan-500/20 rounded-lg flex items-center justify-center mx-auto mb-4">
          ...
          <Card className="p-6 text-center">
            <div className="size-12 bg-blue-500/20 rounded-lg flex items-center justify-center mx-auto mb-4">
          ...
          <Card className="p-6 text-center">
            <div className="size-12 bg-purple-500/20 rounded-lg flex items-center justify-center mx-auto mb-4">
        ...
        <Card className="p-8 bg-gradient-to-r from-purple-500/5 to-pink-500/5 border-purple-500/20">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-4 flex items-center justify-center gap-3">
              <Puzzle className="size-8 text-purple-500" />
      ...
      >
        <Card className="p-8 bg-gradient-to-r from-cyan-500/10 to-cyan-500/5 border-cyan-500/20 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            We're building the reward infrastructure for Stellar development. Stay tuned for updates
            and be among the first to earn rewards for your activities on Stellar Studio.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="text-center">
              <div className="size-8 bg-cyan-500/20 rounded-full flex items-center justify-center mx-auto mb-2">
                <span className="text-cyan-500 font-bold">1</span>
              </div>
              <p className="text-sm text-muted-foreground">Start using Stellar Studio</p>
            </div>
            <div className="text-center">
              <div className="size-8 bg-cyan-500/20 rounded-full flex items-center justify-center mx-auto mb-2">
                <span className="text-cyan-500 font-bold">2</span>
              </div>
              <p className="text-sm text-muted-foreground">Deploy smart contracts</p>
            </div>
            <div className="text-center">
              <div className="size-8 bg-cyan-500/20 rounded-full flex items-center justify-center mx-auto mb-2">
